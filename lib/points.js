...
var Points = function () {
    ...
    _createClass(Points, [{
        ...
        value: function fillStartData(stationsList, goingSpeed, reservedTime, myIgnoringFragments, ignoringRoutes) {
            if (ignoringRoutes == null || !ignoringRoutes.includes(null)) this.finalPoint.tryUpdate(getTimeForGoingTo((0, _geoCoordsDistance2.default)(this.startPoint.coords, this.finalPoint.coords), goingSpeed) /*+ 1800/*+ TimeSpan.FromMinutes(20)*/, this.startPoint, null, null);
        ...
        value: function countFirstShortestWay(ignoringRoutes, myIgnoringFragments, time, types, speed, reservedTime) {
        ...
        value: function optimizeFindedWay(ignoringRoutes, myIgnoringFragments, time, types, speed, reservedTime) {
            var tmp = [];
            //console.log("\n\n\nTry optimize...");
            ...
            for (var currentPoint = this.finalPoint.previousPoint, selectedRoute = currentPoint.fromWhichRoute, previousPoint = currentPoint.previousPoint; currentPoint !== this.startPoint; currentPoint = previousPoint, selectedRoute = currentPoint.fromWhichRoute, previousPoint = currentPoint.previousPoint) {
