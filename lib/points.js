    ...
    _createClass(Points, [{
        ...
        value: function countFirstShortestWay(ignoringRoutes, myIgnoringFragments, day, time, types, speed, reservedTime) {
            ...
            if (oldDistance > minimalDistance) {
                for (var _selectedPoint = this.finalPoint.previousPoint, timeSeconds = _selectedPoint.totalTimeSeconds;;) {

                    if ((0, _geoCoordsDistance2.default)(_selectedPoint.coords, this.finalPoint.coords) === minimalDistance || _selectedPoint.totalTimeSeconds > timeSeconds + 600) break;
