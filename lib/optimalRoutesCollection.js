...
var OptimalRoutesCollection = function (_Array) {
    ...
    function OptimalRoutesCollection(allStations, nowPos, needPos, time, types, speed, dopTimeMinutes, oneWayOnly) {
        ...
        if (!oneWayOnly) {
            ...
            for (var selectedOptimalRoute = _this[0]; selectedOptimalRoute != null && totalCount < maxCount; selectedOptimalRoute.setVisited(), selectedOptimalRoute = _this.selectOptimalRouteWithMinimalMark(), totalCount++) {
                var ddd = 0.9;
                ...
                for (var i = 0, n = ignoringRoutes.length, r = ignoringRoutes[0]; i < n; r = ignoringRoutes[++i]) {
                    ...
                    if (tmpOptimalRoute.oldTotalTimeSeconds <= _this[0].oldTotalTimeSeconds / ddd + 1800) {
