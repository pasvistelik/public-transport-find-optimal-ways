...
var Point = function () {
    ...
    _createClass(Point, [{
        key: "tryUpdate",
        value: function tryUpdate(totalTimeSeconds, previousPoint, fromWhichStation, fromWhichRoute, arrivalTime, dispatchTime, dispatchTimeFromPrevious, totalGoingTimeSeconds, updateIgnore) {
            if (totalTimeSeconds < this.totalTimeSeconds || updateIgnore) {
